# Contract Artifact Card: product brief
...
1. Connect a Wallet Standard wallet or EIP-1193 wallet to identify the creator and inspect v1 support.
2. Edit the supplied evm example.
